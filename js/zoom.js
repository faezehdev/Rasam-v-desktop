...
let results = document.querySelectorAll('.myresult')
for(let i=0;i<images.length;i++){
    imageZoom(images[i],results[i]);
}
...
function imageZoom(imgClass, resultClass) {
  ...
  img = imgClass;
  result = resultClass;
    document.querySelector('.img-zoom-container').addEventListener('mouseenter',()=>{
    result.style.opacity =1;
    document.querySelector('.img-zoom-lens').style.opacity =1;
})
document.querySelector('.img-zoom-container').addEventListener('mouseleave',()=>{
    result.style.opacity =0;
    document.querySelector('.img-zoom-lens').style.opacity =0;
})
  /*create lens:*/
